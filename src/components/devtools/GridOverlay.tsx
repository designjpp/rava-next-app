...
const GridContainer = styled(Container)<{ isVisible: boolean }>`
  height: 100%;
...
const Button = styled.div<{ isVisible: boolean }>`
  position: fixed;
  right: 75px;
  top: 0;
  z-index: 10000;
    ...
    <Grid ref={gridOverlayRef}>
      ...
      {button && (
        <Button onClick={() => handleToggle(!isVisible)} isVisible={isVisible}>
          <Svg width="14px" height="14px" viewBox="0 0 14 14" isVisible={isVisible}>
